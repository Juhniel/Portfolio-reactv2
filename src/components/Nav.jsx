...
export default function Nav({handleSwitchComponent, showWork, showAllProjects, isMobileDevice}) {
  ...
  return (
    <nav className="hidden lg:inline-block fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50">
